        ...
        <div class="card-body">
          ...
          <form action="save" method="post" class="row">
            ...
            <div class="form-group col-md-4">
              <label for="name">供应商名称（必填）</label>
              <input type="text" class="form-control" id="name" name="name" placeholder="请输入供应商名称" />
            </div>
            
            <div class="form-group col-md-4">
              <label for="contacts">联系人姓名（必填）</label>
              <input type="text" class="form-control" id="contacts" name="contacts" placeholder="请输入联系人姓名" />
            </div>
          
          	<div class="form-group col-md-4">
              <label for="contactTel">联系电话（必填）</label>
              <input type="text" class="form-control" id="contactTel" name="contactTel" placeholder="请输入联系电话" />
            </div>
            
            <div class="form-group col-md-4">
              <label for="bankName">开户银行（必填）</label>
              <input type="text" class="form-control" id="bankName" name="bankName" placeholder="请输入开户银行" />
            </div>
            
            <div class="form-group col-md-4">
              <label for="bankAccount">银行账号（必填）</label>
              <input type="text" class="form-control" id="bankAccount" name="bankAccount" placeholder="请输入银行账号" />
            </div>
