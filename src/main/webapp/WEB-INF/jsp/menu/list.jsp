        ...
        <div class="card-toolbar clearfix">
          <form id="f1" class="row" method="post" action="list" role="form">
			<div class="form-group col-md-3">
              ...
              <input type="text" class="form-control" id="name" name="name" value="${role.name }" placeholder="请输入姓名">
            </div>
            <div class="form-group col-md-12">
              ...
              <button type="button" class="btn btn-primary" onclick="location.href='save'"><i class="mdi mdi-plus"></i> 新增</button>
              ...
              <tbody>
              	<c:forEach items="${page.list }" var="menu">
	                <tr>
	                  ...
	                  <td>${menu.url }</td>
	                  <td>${menu.parentId }</td>
	                  <td><my:hello data="${dictMap['SYS_MENU_LEVEL'] }" value="${menu.mlevel }"/></td>
	                  <td><my:hello data="${dictMap['SYS_USE_FLAG'] }" value="${menu.useFlag }"/></td>
	                  <td>
	                    <div class="btn-group">
