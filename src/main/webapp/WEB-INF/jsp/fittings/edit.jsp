					...
					<div class="card-body">
						...
						<form action="update" method="post" class="row">
							...
							<div class="form-group col-md-4">
								...
								<input type="text" class="form-control" id="name" name="name" value="${edit.name }" placeholder="请输入配件名称" />
							</div>

							<div class="form-group col-md-4">
								<label for="brand">品牌（必填）</label> <input type="text" class="form-control" id="brand" name="brand" value="${edit.brand }" placeholder="请输入品牌" />
							</div>

							<div class="form-group col-md-4">
								<label for="unit">单位（必填）</label>
								<div class="form-controls">
									<my:select name="unit" id="unit" css="form-control" data="${dictMap['CAR_UNIT'] }" value="${edit.unit }"/>
								</div>
							</div>

							<div class="form-group col-md-4">
								<label for="price">单价（必填）</label> 
								<input type="text" class="form-control" id="price" name="price" value="${edit.price }" placeholder="请输入单价" />
							</div>

							<div class="form-group col-md-4">
								<label for="type">型号（必填）</label> 
								<input type="text" class="form-control" id="type" name="type" value="${edit.type }" placeholder="请输入型号" />
							</div>
